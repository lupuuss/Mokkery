...
By default, Mokkery is applied to all Kotlin source sets in the project whose names contain the word 'test' in a case-insensitive manner.

> **Warning**
> Before version 2.1.0, Mokkery was applied by default only to source sets whose names contained the phrase 'Test' in a case-sensitive manner.
