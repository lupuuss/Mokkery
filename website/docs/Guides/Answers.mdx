...
It's possible to provide human-readable explanation of the answer, by implementing `Renderable`.
...
// ...
private class ReturnsDelayedAnswer<T>(private val value: T) : Answer<T>, Renderable {
    // ...
    context(scope: MokkeryRenderingScope)
    override fun render(): String = "returnsDelayed ${scope.descriptionRenderer.render(value)}"
}
```
