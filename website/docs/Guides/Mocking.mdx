...
```
:::warning
Make sure that you are calling a method of `BooksRepository`! Mocking extension functions is not supported!
:::
...
Be aware that this plugin makes your types open in a production code. It might be problematic in case your artifacts being consumed by other libraries.
