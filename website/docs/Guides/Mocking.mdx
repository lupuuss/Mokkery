...
### Final classes
Mocking final classes that are already compiled is currently not possible.
This includes any class defined in the main source set. However, you can "open" your final classes in the main source set using the all-open plugin.
