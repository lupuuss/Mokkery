...
class ContextCallInterceptorTest {
    ...
    fun testCallAllInterceptorsInTheChain() {
        ...
        val c = interceptor { 1 }
        val interceptor = ContextCallInterceptor(a, b, c)
    ...
    fun testAllowsChangingContext() {
        ...
        val c = interceptor { it.mokkeryContext[TestMokkeryContext.Key]?.value }
        val result = ContextCallInterceptor(a, b, c)
    ...
    fun testAllowsChangingContextSuspend() = runTest {
        ...
        val c = interceptorSuspend { it.mokkeryContext[TestMokkeryContext.Key]?.value }
        val result = ContextCallInterceptor(a, b, c)
    ...
    fun testAllowsStoppingChain() {
        ...
        val result = ContextCallInterceptor(a, b, c).intercept(testBlockingCallScope<Unit>())
        assertEquals(10, result)
    }
    ...
    fun testAllowsStoppingChainSuspend() = runTest {
        ...
        val result = ContextCallInterceptor(a, b, c).intercept(testSuspendCallScope<Unit>())
        assertEquals(11, result)
    }
