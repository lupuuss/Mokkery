 ...
 */
public inline fun <reified T> ArgMatchersScope.contentDeepEq(array: Array<T>): Array<T> = erasedMatcherCode

/**
 * Matches an array that has the same content as [array].
 */
public inline fun <reified T> ArgMatchersScope.contentEq(array: Array<T>): Array<T> = erasedMatcherCode
