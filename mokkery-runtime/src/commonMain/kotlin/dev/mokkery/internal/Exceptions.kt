...
internal class ErasedMokkeryMatcherCalledException : MokkeryRuntimeException(
    """
        This matcher should have been correctly inlined by the compiler plugin, but it wasn't!
         Please ensure that Mokkery is properly applied both in the project that declares the matcher and in the project that uses it.
    """.trimIndent()
)
