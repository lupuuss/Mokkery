 ...
 */
public suspend fun MokkerySuspendCallScope.callSuspendOriginal(args: List<Any?>): Any? = callSuspendSuper(methodOriginType, args)
 ...
 */
public suspend fun MokkerySuspendCallScope.callSuspendSuper(superType: KClass<*>, args: List<Any?>): Any? {
    checkArgs(args)
    return supers[superType]
        .let { it ?: throw MissingSuperMethodException(superType) }
