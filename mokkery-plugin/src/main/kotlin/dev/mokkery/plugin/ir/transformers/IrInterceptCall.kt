...
fun IrBlockBodyBuilder.irInterceptCall(
    ...
    val interceptorProperty = transformer.getProperty(MokkeryIr.Property.callInterceptor).getter!!
    val interceptorClass = interceptorProperty.returnType.classOrFail
    val getSpiedObject = transformer.getProperty(MokkeryIr.Property.spiedObject).getter!!
...
private fun IrBuilderWithScope.irCallArgsList(
    ...
    val callArgClass = scope.getClass(MokkeryIr.Class.CallArgument)
...
private fun IrBuilderWithScope.kClassWithTypeSubstitution(
    ...
    ?.let { index ->
        irCall(transformer.getFunction(MokkeryIr.Function.typeArgumentAt)) {
            arguments[0] = mokkeryInstance
            arguments[1] = irInt(index)
        }
