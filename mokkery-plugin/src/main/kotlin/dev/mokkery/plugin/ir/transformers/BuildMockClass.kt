...
fun TransformerScope.buildMockClass(
    ...
    val instanceScopeClass = getClass(MokkeryIr.Class.MokkeryInstanceScope)
...
fun TransformerScope.buildManyMockClass(classesToMock: List<IrClass>): IrClass {
    val manyMocksMarkerClass = getClass(MokkeryIr.Class.mockMany(classesToMock.size))
    val mokkeryInstanceClass = getClass(MokkeryIr.Class.MokkeryInstanceScope)
...
private fun IrClass.addMockClassConstructor(
    ...
    val mokkeryScopeClass = transformer.getClass(MokkeryIr.Class.MokkeryScope)
    val mockModeClass = transformer.getClass(MokkeryIr.Class.MockMode)
    val invokeInstantiationCallbacksFun = transformer.getFunction(MokkeryIr.Function.invokeInstantiationListener)
    ...
    addConstructor {
        ...
        body = DeclarationIrBuilder(context, symbol).irBlockBody {
            ...
            +irSetPropertyField(
                ...
                value = irCall(transformer.getFunction(MokkeryIr.Function.createInstanceContext)) {
