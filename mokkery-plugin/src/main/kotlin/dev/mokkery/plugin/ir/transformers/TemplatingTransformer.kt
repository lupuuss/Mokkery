...
import dev.mokkery.plugin.ir.transformers.core.mokkeryErrorAt
...
class TemplatingTransformer(
    ...
    private val runTemplateBlockingFun = getFunction(MokkeryIr.Function.runTemplate)
    private val runTemplateSuspendFun = getFunction(MokkeryIr.Function.runTemplateSuspend)
    private val checkNotMockFun = getFunction(MokkeryIr.Function.checkNotMock)
    private val templatingParameterClass = getClass(MokkeryIr.Class.TemplatingParameter)
    ...
    private val defaultValuesMatcherConstructor = getClass(MokkeryIr.Class.DefaultValuesMatcher).primaryConstructor!!
    ...
    ) = irCallConstructor(getClass(MokkeryIr.Class.CompositeVarArgMatcher).primaryConstructor!!) {
