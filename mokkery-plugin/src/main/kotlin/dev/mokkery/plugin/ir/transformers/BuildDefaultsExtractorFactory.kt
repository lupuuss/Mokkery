...
private fun TransformerScope.buildDefaultsExtractorOrNull(
    ...
    val throwArgumentsFunction = getFunction(MokkeryIr.Function.throwArguments)
    val methodWithoutDefaultFunction = getFunction(MokkeryIr.Function.methodWithoutDefaultsError)
...
private fun TransformerScope.buildDefaultsFactoryClassWith(className: Name, constructor: IrConstructor): IrClass {
    val irBuiltIns = pluginContext.irBuiltIns
    val defaultsExtractorFactoryInterface = getClass(MokkeryIr.Class.DefaultsExtractorFactory)
    ...
    currentFileValue.addChild(defaultsExtractorFactoryClassImpl)
