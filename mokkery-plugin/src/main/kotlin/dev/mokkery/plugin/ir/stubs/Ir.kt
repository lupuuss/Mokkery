...
import dev.mokkery.plugin.ir.stubs.Stub
import dev.mokkery.plugin.ir.stubs.StubStrategyScope
import dev.mokkery.plugin.ir.stubs.with
...
private fun IrBlockBodyBuilder.irCallError(
    message: String
): IrCall = irCall(MokkeryIr.Function.mokkeryRuntimeError.resolve(scope.plugin)) {
