...
import dev.mokkery.plugin.fir.isArgMatchersScope
...
class MatchersDeclarationChecker(
    ...
    private fun ConeKotlinType.isArgMatcherOrArgMatcherScope(session: FirSession) = isArgMatcherType(session) || isArgMatchersScope()
