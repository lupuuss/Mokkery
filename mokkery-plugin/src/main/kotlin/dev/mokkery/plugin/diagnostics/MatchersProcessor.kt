...
fun MatchersProcessor.usesMatchers(expression: FirExpression?): Boolean = extractAllMatcherTypes(expression).any()

fun MatchersProcessor.usesMatchers(call: FirFunctionCall): Boolean = extractMatcherType(call) != null

fun MatchersProcessor.usesVarargMatchers(expression: FirExpression?): Boolean = extractAllMatcherTypes(expression).any {
    it.isVararg
}
