...
fun IrBlockBodyBuilder.irCallIsTemplatingEnabled(
    ...
    getTemplatingCall.dispatchReceiver = irCall(mokkerySpyScopeClass.getPropertyGetter("interceptor")!!).apply {
        dispatchReceiver = mokkeryScope
    }
    val templatingInterceptorClass = transformer.getClass(Mokkery.Class.TemplatingInterceptor)
    val isEnabledCall = irCall(templatingInterceptorClass.getPropertyGetter("isEnabled")!!).apply {
