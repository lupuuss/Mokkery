...
class MatchersCompiler(
    ...
    private val generatedCodeGetter = getProperty(Mokkery.Property.generatedCode).getter!!
    ...
    override fun visitFunction(declaration: IrFunction): IrStatement {
        ...
        pluginContext.irFactory.buildFun {
            ...
            val matcherType = if (anyCompositeParams) argMatcherCompositeClass else argMatcherClass
    ...
    private fun IrFunction.eraseFrontMatcherBody() {
        body = declarationIrBuilder(symbol) {
            irBlockBody {
                +irReturn(irCall(generatedCodeGetter))
            }
        }
    }
