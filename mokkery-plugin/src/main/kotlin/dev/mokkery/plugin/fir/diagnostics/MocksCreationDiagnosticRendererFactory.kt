...
import dev.mokkery.plugin.fir.diagnostics.MocksCreationChecker.Diagnostics
...
class MocksCreationDiagnosticRendererFactory : BaseDiagnosticRendererFactory() {
    ...
    override val MAP by KtDiagnosticFactoryToRendererMap("MokkeryMocksCreationDiagnostic") {
        it.put(
