...
import dev.mokkery.plugin.fir.diagnostics.MatchersUsageReporterVisitor.Diagnostics
...
class MatchersUsageDiagnosticRendererFactory : BaseDiagnosticRendererFactory() {
    ...
    override val MAP by KtDiagnosticFactoryToRendererMap("MokkeryMatchersUsageDiagnostic") {
